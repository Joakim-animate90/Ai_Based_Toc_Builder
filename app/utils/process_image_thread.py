...
class PDFToBase64Thread:
    ...
    def convert_pdf_to_base64_images(self, pdf_path, max_pages=20):
        ...
        print(f"Converting {pages_to_process} pages to images using {self.num_threads} threads...")
        
        with ThreadPoolExecutor(max_workers=self.num_threads) as executor:
            # Submit all tasks to the executor
            future_to_page = {executor.submit(self._process_page, pdf_document, page_num, pages_to_process): page_num 
